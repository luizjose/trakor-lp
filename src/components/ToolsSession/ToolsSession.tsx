      ...
      <div className="text-left xl:flex-1/2 flex-2/5">
        ...
        <ScrollReveal delay={0.6}>
          <p className="text-[#CBD5E1] text-base xl:text-lg mt-2 mb-4 leading-relaxed">
            Soluções criadas para ajudar equipes modernas a serem mais
            produtivas. Controle, visibilidade e integração em um só painel.
          </p>
        </ScrollReveal>
        <ul className="text-[#CBD5E1] space-y-2 mb-6 text-sm xl:text-base">
          <ScrollReveal delay={0.8}>
            <li>
              <strong className="text-[#6366F1]">✓</strong> Interdum volutpat
              turpis malesuada ac turpis.
            </li>
          </ScrollReveal>
          <ScrollReveal delay={0.9}>
            <li>
              <strong className="text-[#6366F1]">✓</strong> Tortor ipsum pretium
              quis nunc.
            </li>
          </ScrollReveal>
          <ScrollReveal delay={1.0}>
            <li>
              <strong className="text-[#6366F1]">✓</strong> Vitae odio a id
              purus in.
            </li>
          </ScrollReveal>
        </ul>
