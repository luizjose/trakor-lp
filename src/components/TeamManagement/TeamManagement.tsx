      ...
      <div className="text-left xl:flex-1/2 flex-2/5">
        ...
        <ScrollReveal delay={0.6}>
          <p className="text-[#CBD5E1] text-base xl:text-lg mt-2 mb-4 leading-relaxed">
            Alinhe tarefas, defina prioridades e mantenha a equipe conectada.
            Sincronize projetos com facilidade e acompanhe o progresso em tempo
            real.
          </p>
        </ScrollReveal>
        <ul className="text-[#CBD5E1] space-y-2 mb-6 text-sm xl:text-base">
          <ScrollReveal delay={0.8}>
            <li>
              <strong className="text-[#6366F1]">✓</strong> Planejamento e
              acompanhamento de tarefas
            </li>
          </ScrollReveal>
          <ScrollReveal delay={0.9}>
            <li>
              <strong className="text-[#6366F1]">✓</strong> Comunicação
              integrada
            </li>
          </ScrollReveal>
          <ScrollReveal delay={1.0}>
            <li>
              <strong className="text-[#6366F1]">✓</strong> Colaboração em tempo
              real
            </li>
          </ScrollReveal>
        </ul>
